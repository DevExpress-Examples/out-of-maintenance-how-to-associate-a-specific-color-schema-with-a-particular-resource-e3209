...
Namespace QueryResourceColorSchema
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Start = New System.DateTime(2011, 5, 6, 0, 0, 0, 0)
...
'			Me.schedulerControl1.QueryResourceColorSchema += New DevExpress.XtraScheduler.QueryResourceColorSchemaEventHandler(Me.schedulerControl1_QueryResourceColorSchema);
'			Me.schedulerControl1.SelectionChanged += New System.EventHandler(Me.schedulerControl1_SelectionChanged);
			...
			Me.rbCaramel.Text = "Caramel"
			Me.rbCaramel.UseVisualStyleBackColor = True
'			Me.rbCaramel.CheckedChanged += New System.EventHandler(Me.radioButton2_CheckedChanged);
			' 
			' rbDXStyle
			' 
...
'			Me.rbDXStyle.CheckedChanged += New System.EventHandler(Me.radioButton1_CheckedChanged);
			' 
